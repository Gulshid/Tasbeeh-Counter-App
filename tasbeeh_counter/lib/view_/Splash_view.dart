      ...
      body: Column(
        ...
        children: [
          //Splash App Image in top center
            ClipRRect(
              child: Image.asset('assets/tasbeeh.png', height: 120.h, width: 120.w, fit: BoxFit.fill,),
            ),

            Center(child: Text('Tasbeeh Counter App', style: GoogleFonts.agbalumo(color: Colors.white, fontSize: 30.sp),),),
